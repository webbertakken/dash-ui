        ...
        <Card span={8}>
          ...
          <table>
            ...
            <tbody>
              {HOOKS.map((r) => (
                <tr key={r[0]}>
                  <td style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 11, color: '#C8C9D0' }}>{r[0]}</td>
          ...
          {KEYS.map((k) => (
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: 11, color: '#6E7079', marginTop: 2 }}>
                  {k[1]} · {k[2]}
                </div>
              </div>
              {k[3] === 'active' ? (
                ...
                <span className="pill" style={{ color: '#FF7B7B', background: 'rgba(240,58,58,0.12)' }}>
                  <span className="dot" />
                  Revoked
                </span>
              )}
