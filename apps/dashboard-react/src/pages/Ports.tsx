...
const ALL_PORTS: TransferListItem[] = [
  2, 3, 6, 7, 8, 9, 11, 12, 14, 15, 16, 17, 18, 19, 20, 22, 23, 24,
].map((n) => ({
  id: `p${n}`,
    ...
    <>
      ...
      <div className="grid">
        <Card span={12}>
          ...
          >
            <Legend
              swatch="rgba(0,176,112,0.3)"
              border="rgba(0,176,112,0.5)"
              label="Connected · 16"
            />
              ...
              {PORTS.map((p) => (
                <tr key={p[0]}>
                  ...
                  <td>
                    ...
                    >
                      <span
                        style={{ width: 6, height: 6, borderRadius: '50%', background: p[7] }}
                      />
                      {p[8]}
                    </span>
                  </td>
        ...
        <Card span={12}>
          <h3>
            VLAN port assignment <span className="unit">VLAN 10 · Corporate</span>
          </h3>
        ...
        <Card span={6}>
          ...
          {[
            ...
            >
              ...
              <div
                style={{ fontSize: 13, fontVariantNumeric: 'tabular-nums', color, fontWeight: 600 }}
              >
                {watts}
              </div>
              <div
              ...
              >
                <div
                  style={{
                    height: '100%',
                    width: watts === '0 W' ? '0%' : `${(parseInt(watts) / 40) * 100}%`,
                    background: color,
                    borderRadius: 2,
                  }}
                />
          ...
          >
            ...
            <span style={{ color: '#fff', fontVariantNumeric: 'tabular-nums', fontWeight: 600 }}>
              186 W <span style={{ color: '#6E7079', fontWeight: 400 }}>/ 400 W budget</span>
            </span>
          </div>
        </Card>
        ...
        <Card span={12}>
          <h3>
            Protocol traffic · 24 h <span className="unit">Mbps per 2 h</span>
          </h3>
          <StackedBarChart
        ...
        <Card span={12}>
          <h3>
            Port-to-VLAN traffic matrix <span className="unit">Mbps · 24 h</span>
          </h3>
          <MatrixChart
            rows={TRAFFIC_ROWS}
            cols={TRAFFIC_COLS}
