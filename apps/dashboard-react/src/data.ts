...
export const LOG_ROWS: [string, string, string, string, string, string][] = [
  [
    ...
    'Client connected',
    'Maria · MacBook Pro',
    'c8:69:cd:11:23:11 ↔ AP Pro · Lobby (5 GHz)',
  ],
  [
    'warn',
    'Network',
    ...
    'AP-Plus · Conference',
    '2.4 GHz at 71% over 3 min',
  ],
  [
    'danger',
    'Security',
    '12:41:02',
    'Threat blocked · Mirai C2',
    '192.168.30.18',
    '185.220.101.42:8443 — IDS sig 1:2024918',
  ],
  ...
  [
    ...
    'Port up',
    'ES-24-Pro · port 21',
    '2.5 Gbps full-duplex · NAS uplink',
  ],
  [
    'info',
    'Protect',
