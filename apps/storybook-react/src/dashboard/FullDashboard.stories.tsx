...
const meta: Meta<typeof App> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'The complete dashboard app, exactly as shipped in apps/dashboard-react. Use the sidebar inside the canvas to switch between Dashboard, Devices, Topology, Settings (8 tabs) and the rest.',
      },
    },
  },
}
