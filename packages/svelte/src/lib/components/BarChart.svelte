...
<script lang="ts">
  ...
  export let series: BarChartSeries[] = [];
  export let labels: string[] = [];
  export let height: number = 160;
  export let ariaLabel: string = 'Bar chart';
