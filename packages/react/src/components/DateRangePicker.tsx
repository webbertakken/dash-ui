    ...
    return (
      <div className="drp-month">
        <div className="dp-header">
          ...
          <span className="dp-month-label" aria-live="polite">{MONTHS[gridMonth]} {gridYear}</span>
        ...
        <table role="grid" className="dp-grid" aria-label={`${MONTHS[gridMonth]} ${gridYear}`}>
          <thead>
            <tr>{DAYS.map((d) => <th key={d} scope="col" abbr={d}>{d}</th>)}</tr>
          </thead>
          <tbody>
  ...
  return (
    <div className="drp-root">
      <button
        ...
        disabled={disabled}
        onClick={() => {
          if (open) { setOpen(false); setPicking(null); } else setOpen(true);
        }}
      >
      ...
      {open && (
        ...
        >
          ...
          {picking && (
            <p className="drp-hint" aria-live="polite">Pick the end date</p>
          )}
        </div>
      )}
    </div>
