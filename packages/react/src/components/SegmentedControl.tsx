...
export function SegmentedControl({
  ...
  return (
    <div ref={rootRef} role="radiogroup" aria-label={label} className="seg-ctrl" onKeyDown={handleKeyDown}>
      {options.map((opt) => (
        <button
          key={opt.value}
          type="button"
          ...
          className={['seg-ctrl__btn', active === opt.value && 'seg-ctrl__btn--active'].filter(Boolean).join(' ')}
