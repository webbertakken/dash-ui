...
export function ScatterPlot({ points, xRange, yRange, height = 160, ariaLabel = 'Scatter plot' }: ScatterPlotProps) {
  ...
  return (
    <div role="img" aria-label={ariaLabel} style={{ width: '100%' }}>
      ...
      >
        {gridLines.map((g, i) => (
          <g key={i}>
            <line x1={g.x} y1={PAD.t} x2={g.x} y2={PAD.t + (height - PAD.t - PAD.b)} stroke="rgba(255,255,255,0.06)" strokeWidth={1} />
