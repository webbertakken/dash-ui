    ...
    <div role="img" aria-label={ariaLabel} style={{ width: '100%' }}>
      ...
      >
        {axes.map((axis, i) => {
          ...
          return (
            <g key={i}>
              <line x1={x} y1={PAD_T} x2={x} y2={VH - PAD_B} stroke="rgba(255,255,255,0.2)" strokeWidth={1} />
              <text x={x} y={PAD_T - 8} fill="#A4A7B5" fontSize={8} textAnchor="middle" fontFamily="inherit">
                {axis.label}
              </text>
              {axis.unit && (
                <text x={x} y={PAD_T - 1} fill="#6E7079" fontSize={7} textAnchor="middle" fontFamily="inherit">
                  {axis.unit}
                </text>
              )}
              {TICKS.map(t => {
                ...
                return (
                  <g key={t}>
                    <line x1={x - 3} y1={y} x2={x + 3} y2={y} stroke="rgba(255,255,255,0.25)" strokeWidth={1} />
                    <text x={x - 5} y={y + 3} fill="#6E7079" fontSize={7} textAnchor="end" fontFamily="inherit">
