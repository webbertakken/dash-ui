...
export const DownloadIcon = (p: IconProps) => (
  <svg viewBox="0 0 14 14" {...base({ size: 14, ...p })}>
    <path
      d="M7 1.5v7m0 0L4.5 6m2.5 2.5L9.5 6M2 11h10"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
...
export const BellIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    <path
      d="M4 6.5a4 4 0 0 1 8 0V9l1.2 2H2.8L4 9V6.5ZM6.5 12.5a1.5 1.5 0 0 0 3 0"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const HelpIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    ...
    <path
      d="M6.4 6.2c.2-1 1-1.5 1.9-1.5 1.1 0 1.9.7 1.9 1.7s-.6 1.4-1.4 1.8c-.6.3-1 .6-1 1.2v.3M8 11.6h0"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const UpdatesIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    <path
      d="M8 2v6m0 0L5 5.5M8 8l3-2.5M3 12h10M3 14h10"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const TopologyIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    ...
    <path
      d="M8 5.1v2.4M6.7 8.5l-2.4 2.6M9.3 8.5l2.4 2.6"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const WifiIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    <path
      d="M2 6c3-3 9-3 12 0M4 9c2.5-2.5 5.5-2.5 8 0"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const SecurityIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    <path
      d="m8 1.5 5 2v4.5c0 3-2 5.5-5 6.5-3-1-5-3.5-5-6.5V3.5l5-2Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinejoin="round"
    />
...
export const SettingsIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    ...
    <path
      d="M8 1.5v1.6M8 12.9v1.6M14.5 8h-1.6M3.1 8H1.5m11-4.6-1.1 1.1M4.6 11.4l-1.1 1.1m0-9 1.1 1.1m6.7 6.7 1.1 1.1"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const WirelessIcon = (p: IconProps) => (
  <svg viewBox="0 0 16 16" {...base(p)}>
    <path
      d="M2 11s1.5-1 6-1 6 1 6 1M2 8s1.5-1.5 6-1.5 6 1.5 6 1.5M2 5s1.5-2 6-2 6 2 6 2"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
