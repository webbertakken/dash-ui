// Render fixtures for every public React component in @w5-ui/react.
...
export const FIXTURES: Record<string, Variant[]> = {
  Accordion: [
    {
      ...
      node: (
        <U.Accordion>
          <U.AccordionItem title="One">One</U.AccordionItem>
          <U.AccordionItem title="Two" defaultOpen>
            Two
          </U.AccordionItem>
        </U.Accordion>
      ),
  ...
  AccordionItem: [
    { name: 'closed', node: <U.AccordionItem title="Item">body</U.AccordionItem> },
    {
      name: 'open',
      node: (
        <U.AccordionItem title="Item" defaultOpen>
          body
        </U.AccordionItem>
      ),
    },
  ...
  ActionMenu: [
    {
      ...
      node: (
        <U.ActionMenu
          items={[
            { id: 'a', label: 'Edit' },
            { id: 'b', label: 'Delete', danger: true, disabled: true },
          ]}
          onAction={noop}
        />
      ),
  ...
  ActivityFeed: [
    {
      name: 'default',
      node: <U.ActivityFeed items={[{ id: '1', title: 'Joined', time: 'now' }]} />,
    },
    {
      name: 'busy + autoscroll',
      node: (
        <U.ActivityFeed
          items={[{ id: '1', title: 'Joined', description: 'desc', time: 'now', severity: 'warn' }]}
          busy
          autoScroll
        />
      ),
  ...
  Alert: [
    ...
    {
      name: 'success dismiss',
      node: (
        <U.Alert variant="success" onDismiss={noop}>
          ok
        </U.Alert>
      ),
    },
  ...
  AnnotatedTimeSeries: [
    {
      name: 'default',
      node: (
        <U.AnnotatedTimeSeries
          data={values6a}
          labels={labels6}
          annotations={[{ index: 2, label: 'spike' }]}
        />
      ),
    },
          ...
          sections={[
            {
              title: 'Manage',
              items: [
                { id: 'dash', label: 'Dashboard', icon: null, count: 3, pill: 1 },
                { id: 'devs', label: 'Devices', icon: null },
              ],
            },
          ]}
          onChange={noop}
  ...
  AreaChart: [{ name: 'default', node: <U.AreaChart series={series2x4} labels={labels4} /> }],
  Avatar: [
    { name: 'initials', node: <U.Avatar initials="WB" /> },
    {
      name: 'image',
      node: <U.Avatar src="data:image/svg+xml,<svg/>" alt="me" size="lg" status="online" />,
    },
  ...
  AvatarGroup: [
    {
      name: 'default',
      node: <U.AvatarGroup avatars={[{ initials: 'A' }, { initials: 'B' }, { initials: 'C' }]} />,
    },
    {
      name: 'overflow',
      node: (
  ...
  Badge: [
    ...
    { name: 'showZero false', node: <U.Badge count={0}>x</U.Badge> },
    {
      name: 'showZero true',
      node: (
        <U.Badge count={0} showZero color="info">
          x
        </U.Badge>
      ),
    },
  ...
  BarChart: [{ name: 'default', node: <U.BarChart series={series2x4} labels={labels4} /> }],
  BeeswarmChart: [
    {
      name: 'default',
      node: (
    ...
    {
      name: 'with yRange',
      node: <U.BeeswarmChart series={[{ label: 'A', points: [1, 2] }]} yRange={[0, 10]} />,
    },
  ],
  BoxPlot: [
    {
    ...
    },
    {
      name: 'yRange',
      node: (
        <U.BoxPlot series={[{ label: 'A', q0: 0, q1: 2, q2: 4, q3: 6, q4: 8 }]} yRange={[0, 10]} />
      ),
    },
  ],
  Breadcrumb: [
    {
      ...
      node: (
        <U.Breadcrumb
          items={[{ label: 'Home', href: '/' }, { label: 'Devices' }]}
          onNavigate={noop}
        />
      ),
    },
  ...
  BubbleChart: [
    ...
    {
      name: 'fixed ranges',
      node: <U.BubbleChart points={[{ x: 1, y: 2, r: 5 }]} xRange={[0, 10]} yRange={[0, 10]} />,
    },
  ],
  BulletChart: [
    {
  ...
  Button: [
    ...
    { name: 'danger', node: <U.Button variant="danger">Delete</U.Button> },
    {
      name: 'iconOnly',
      node: (
        <U.Button iconOnly aria-label="x">
          x
        </U.Button>
      ),
    },
  ...
  CalendarHeatmap: [
    ...
    {
      name: 'maxValue',
      node: <U.CalendarHeatmap data={[{ date: '2025-01-01', value: 1 }]} maxValue={10} />,
    },
  ],
  Callout: [
  ...
  CandlestickChart: [
    ...
    {
      name: 'with yRange + unit',
      node: (
        <U.CandlestickChart
          bars={[{ open: 1, close: 2, high: 3, low: 0 }]}
          yRange={[0, 5]}
          unit="$"
        />
      ),
  ...
  Card: [
    { name: 'default', node: <U.Card>x</U.Card> },
    {
      name: 'span',
      node: (
        <U.Card span={2} className="extra">
          x
        </U.Card>
      ),
    },
  ],
  CardTitle: [{ name: 'default', node: <U.CardTitle>Hello</U.CardTitle> }],
  Carousel: [
    {
      name: 'default',
      node: (
  ...
  CommandPalette: [
    {
      ...
      node: (
        <U.CommandPalette
          ...
          onClose={noop}
          items={[
            { id: 'a', label: 'Open A', group: 'Pages', shortcut: 'A' },
            { id: 'b', label: 'Open B' },
          ]}
          onSelect={noop}
        />
    ...
    {
      name: 'closed',
      node: <U.CommandPalette open={false} onClose={noop} items={[]} onSelect={noop} />,
    },
  ],
  ConfirmDialog: [
    {
      name: 'open info',
      node: <U.ConfirmDialog open title="?" description="d" onConfirm={noop} onCancel={noop} />,
    },
    {
      name: 'open danger',
      node: <U.ConfirmDialog open title="?" variant="danger" onConfirm={noop} onCancel={noop} />,
    },
    {
      name: 'closed',
      node: <U.ConfirmDialog open={false} title="?" onConfirm={noop} onCancel={noop} />,
    },
  ],
  ContextMenu: [
    {
    ...
    {
      name: 'closed',
      node: <U.ContextMenu open={false} x={0} y={0} onClose={noop} onAction={noop} items={[]} />,
    },
  ],
  ContextualHelp: [
  ...
  ContourPlot: [
    ...
    {
      name: 'fixed ranges',
      node: <U.ContourPlot points={points} xRange={[0, 10]} yRange={[0, 10]} />,
    },
  ],
  CopyButton: [
  ...
  CumulativeDistribution: [
    {
      name: 'default',
      node: (
        <U.CumulativeDistribution series={[{ label: 'a', color: '#006FFF', values: values6a }]} />
      ),
    },
    {
      name: 'no guides',
      node: (
        <U.CumulativeDistribution
  ...
  Drawer: [
    {
      name: 'open',
      node: (
        <U.Drawer open title="Drawer" onClose={noop}>
          hi
        </U.Drawer>
      ),
    },
  ...
  Field: [
    ...
    },
    {
      name: 'with hint',
      node: (
        <U.Field label="Name" hint="hint" required>
          x
        </U.Field>
      ),
    },
  ...
  FileUpload: [
    ...
    {
      name: 'multiple',
      node: <U.FileUpload label="Logo" hint="png" accept=".png" multiple onFiles={noop} />,
    },
  ...
  Gauge: [
    ...
    {
      name: 'all options',
      node: <U.Gauge value={0.8} label="mem" color="#0f0" size={80} ariaLabel="ag" />,
    },
  ...
  GroupedList: [
    ...
    },
    {
      ...
      node: (
        <U.GroupedList groups={[{ title: 'A', items: [{ label: 'one' }] }]} collapsible={false} />
      ),
    },
  ],
  HealthBar: [
    { name: 'default', node: <U.HealthBar value={0.6} /> },
    {
      name: 'with label',
      node: (
        <U.HealthBar value={0.9} label="cpu" valueText="90%" fillStyle={{ background: '#0f0' }} />
      ),
    },
  ],
  HeatMap: [
  ...
  HexbinChart: [
    ...
    {
      name: 'fixed ranges',
      node: <U.HexbinChart points={points} xRange={[0, 10]} yRange={[0, 10]} />,
    },
  ],
  Histogram: [
    {
  ...
  InlineEdit: [
    { name: 'default', node: <U.InlineEdit value="hi" onConfirm={noop} label="Name" /> },
    {
      ...
      node: <U.InlineEdit value="" onConfirm={noop} label="Name" placeholder="…" />,
    },
  ],
  Input: [
  ...
  InputGroup: [
    ...
    },
    {
      ...
      node: (
        <U.InputGroup prefix="$" suffix="USD">
          <U.Input />
        </U.InputGroup>
      ),
    },
  ...
  JsonViewer: [
    {
      name: 'object',
      node: <U.JsonViewer data={{ a: 1, b: [1, 2], c: { d: true, e: null, f: 'x' } }} />,
    },
    {
      name: 'collapsed',
      node: (
        <U.JsonViewer data={{ a: { b: { c: { d: 1 } } } }} defaultExpanded={false} maxDepth={1} />
      ),
    },
  ...
  KanbanBoard: [
    ...
    {
      name: 'no callback',
      node: <U.KanbanBoard columns={[{ id: 'a', title: 'A', cards: [{ id: '1', title: 't' }] }]} />,
    },
  ],
  Kbd: [
  ...
  LineChart: [{ name: 'default', node: <U.LineChart series={series2x4} labels={labels4} /> }],
  LogViewer: [
    {
      name: 'default',
      node: (
  ...
  MACInput: [
    ...
    {
      name: 'controlled',
      node: <U.MACInput label="MAC" value="ff:ff:ff:ff:ff:ff" onChange={noop} />,
    },
  ...
  MatrixChart: [
    {
      name: 'default',
      node: <U.MatrixChart rows={['r1']} cols={['c1', 'c2']} values={[[0.1, 0.5]]} unit="x" />,
    },
  ],
  Menubar: [
    {
  ...
  MirroredBarChart: [
    {
      name: 'default',
      node: <U.MirroredBarChart items={[{ label: 'A', left: 5, right: 7 }]} unit="GB" />,
    },
  ],
  Modal: [
    {
      name: 'open with footer',
      node: (
        <U.Modal open title="t" onClose={noop} footer={<button>ok</button>}>
          body
        </U.Modal>
      ),
    },
  ...
  MultiSelect: [
    ...
    {
      name: 'no value',
      node: <U.MultiSelect options={[{ value: 'a', label: 'A' }]} label="lab" />,
    },
  ...
  NotificationPanel: [
    ...
    {
      name: 'closed',
      node: <U.NotificationPanel open={false} onClose={noop} notifications={[]} />,
    },
    {
      name: 'no callbacks',
      node: (
  ...
  NumberInput: [
    { name: 'default', node: <U.NumberInput label="N" /> },
    {
      name: 'controlled',
      node: (
        <U.NumberInput label="N" value={5} onChange={noop} min={0} max={10} step={2} suffix="x" />
      ),
    },
  ...
  Pill: [
    ...
    { name: 'neutral', node: <U.Pill>n</U.Pill> },
    {
      name: 'no dot',
      node: (
        <U.Pill showDot={false} className="x">
          n
        </U.Pill>
      ),
    },
  ...
  Popover: [
    { name: 'default', node: <U.Popover label="open">body</U.Popover> },
    {
      name: 'primary',
      node: (
        <U.Popover label="open" variant="primary" title="t" placement="top">
          body
        </U.Popover>
      ),
    },
  ...
  ProgressBar: [
    ...
    {
      name: 'with label',
      node: <U.ProgressBar value={0.9} label="cpu" valueText="90%" color="#0f0" />,
    },
  ],
  PunchCard: [
    {
  ...
  QuadrantChart: [
    ...
    {
      name: 'with custom labels + colors',
      node: (
        <U.QuadrantChart
          ...
          quadrantColors={['#000', '#111', '#222', '#333']}
        />
      ),
    },
  ],
  ...
  RadioGroup: [
    ...
    {
      name: 'defaultValue',
      node: <U.RadioGroup legend="L" options={[{ value: 'a', label: 'A' }]} defaultValue="a" />,
    },
  ],
  RangeSlider: [
    ...
    {
      name: 'controlled',
      node: <U.RangeSlider label="R" low={20} high={80} onChange={noop} suffix="%" />,
    },
    {
      name: 'defaults',
      node: (
        <U.RangeSlider label="R" defaultLow={10} defaultHigh={90} step={5} disabled className="x" />
      ),
    },
  ],
  RankedList: [
  ...
  ResizablePanel: [
    {
      name: 'vertical',
      node: <U.ResizablePanel>{[<div key="a">A</div>, <div key="b">B</div>]}</U.ResizablePanel>,
    },
    {
      name: 'horizontal',
      node: (
  ...
  RidgelinePlot: [
    ...
    {
      name: 'fixed xRange',
      node: <U.RidgelinePlot series={[{ label: 'a', values: values6a }]} xRange={[0, 10]} />,
    },
  ],
  SankeyDiagram: [
    {
  ...
  ScatterPlot: [
    ...
    {
      name: 'fixed ranges',
      node: <U.ScatterPlot points={points} xRange={[0, 10]} yRange={[0, 10]} />,
    },
  ],
  SegmentedControl: [
    {
    ...
    },
    {
      name: 'defaultValue',
      node: (
        <U.SegmentedControl label="L" options={[{ value: 'a', label: 'A' }]} defaultValue="a" />
      ),
    },
  ],
  Select: [
  ...
  Slider: [
    ...
    {
      name: 'controlled',
      node: <U.Slider label="L" value={50} onChange={noop} min={0} max={100} step={5} suffix="%" />,
    },
  ...
  SortableList: [
    ...
    {
      name: 'with aria',
      node: <U.SortableList items={[{ id: '1', label: 'A' }]} onChange={noop} ariaLabel="x" />,
    },
  ],
  SortHeader: [
    {
      ...
      node: (
        <table>
          <thead>
            <tr>
              <U.SortHeader sortKey="a" activeKey="a" dir="asc" onSort={noop}>
                A
              </U.SortHeader>
            </tr>
          </thead>
    ...
    },
    {
      ...
      node: (
        <table>
          <thead>
            <tr>
              <U.SortHeader sortKey="a" activeKey="a" dir="desc" onSort={noop}>
                A
              </U.SortHeader>
            </tr>
          </thead>
    ...
    },
    {
      ...
      node: (
        <table>
          <thead>
            <tr>
              <U.SortHeader sortKey="a" activeKey="b" dir="asc" onSort={noop} style={{ width: 10 }}>
                A
              </U.SortHeader>
            </tr>
          </thead>
  ...
  SplitButton: [
    ...
    },
    {
      ...
      node: (
        <U.SplitButton label="x" variant="primary" disabled items={[{ id: 'a', label: 'A' }]} />
      ),
    },
    {
      name: 'danger',
      node: <U.SplitButton label="x" variant="danger" items={[{ id: 'a', label: 'A' }]} />,
    },
  ],
  Spoiler: [
    {
    ...
    },
    {
      name: 'custom labels',
      node: (
        <U.Spoiler maxHeight={20} showLabel="more" hideLabel="less" className="x">
          <div>x</div>
        </U.Spoiler>
      ),
    },
  ...
  StackedBarChart: [
    ...
    {
      name: 'normalised',
      node: <U.StackedBarChart series={series2x4} labels={labels4} normalized />,
    },
  ...
  StarRating: [
    ...
    {
      name: 'controlled',
      node: <U.StarRating label="rate" value={3} onChange={noop} max={6} size="sm" className="x" />,
    },
  ...
  StepChart: [{ name: 'default', node: <U.StepChart series={series2x4} labels={labels4} /> }],
  Stepper: [
    {
      name: 'default',
      node: (
    ...
    {
      name: 'with className',
      node: <U.Stepper steps={[{ id: 'a', label: 'A' }]} active="a" className="x" />,
    },
  ],
  StreamGraph: [
    {
  ...
  Tabs: [
    {
      ...
      node: (
        <U.Tabs
          items={[
            { id: 'a', label: 'A' },
            { id: 'b', label: 'B', badge: <U.Pill>1</U.Pill> },
          ]}
          active="a"
          onChange={noop}
        />
    ...
    {
      name: 'with aria',
      node: <U.Tabs items={[{ id: 'a', label: 'A' }]} active="a" ariaLabel="t" />,
    },
  ],
  Tag: [
  ...
  TagInput: [
    ...
    {
      name: 'controlled',
      node: <U.TagInput label="L" value={['a']} onChange={noop} placeholder="p" />,
    },
    {
      name: 'disabled',
      node: <U.TagInput label="L" disabled defaultValue={['a', 'b']} className="x" />,
    },
  ],
  Textarea: [
  ...
  Toaster: [{ name: 'default', node: <U.Toaster /> }],
  Toggle: [
  ...
  TransferList: [
    ...
    },
    {
      name: 'controlled',
      node: (
        <U.TransferList source={[{ id: '1', label: 'A' }]} target={[{ id: '2', label: 'B' }]} />
      ),
    },
  ],
  TreeMap: [
  ...
  ViolinPlot: [
    ...
    {
      name: 'with yRange',
      node: <U.ViolinPlot series={[{ label: 'A', values: [1, 2, 3] }]} yRange={[0, 10]} />,
    },
  ],
  VirtualList: [
    {
    ...
    },
    {
      ...
      node: (
        <U.WaterfallChart
          bars={[
            { label: 'a', value: 10, kind: 'start' },
            { label: 'b', value: 1, kind: 'pos' },
            { label: 'c', value: 11, kind: 'end' },
          ]}
        />
      ),
    },
...
for (const name of ICON_NAMES) {
  const Icon = (
    U as unknown as Record<string, (p: { size?: number; className?: string }) => React.ReactElement>
  )[name]
  FIXTURES[name] = [
